  ...
  return (
    <>
            ...
            <Row className='justify-content-center'>
              <Col lg='12'>
                <Row className='row-grid'>
                  <Col lg='4'>
                    <Link to={`${match.url}/gsoc`} style={linkStyle}>
                      <Card className='card-lift--hover shadow border-0'>
                        <CardBody className='py-5'>
                          ...
                          <p className='description mt-3'>
                            How to get selected in GSOC (Google Summer of Code)
                          </p>
                          <div>
                    ...
                    <Link to={`${match.url}/gsoc`} style={linkStyle}>
                      <Card className='card-lift--hover shadow border-0'>
                        <CardBody className='py-5'>
                          ...
                          <p className='description mt-3'>
                            Step by step guide to start your software
                            development freelancing journey.
                          </p>
                          <div>
                    ...
                    <Link to={`${match.url}/gsoc`} style={linkStyle}>
                      <Card className='card-lift--hover shadow border-0'>
                        <CardBody className='py-5'>
                          ...
                          <p className='description mt-3'>
                            Learn programming/coding from scratch, suitable for
                            school students.
                          </p>
                          <div>
      ...
      <Switch>
        ...
        {/* <Route
          path={`${match.url}/:id`}
          render={(props) => <CourseContainer {...props} />}
        /> */}
      </Switch>
    </>
  );
